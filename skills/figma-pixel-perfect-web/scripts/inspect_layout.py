#!/usr/bin/env python3
"""Strict comparator for Figma and implementation JSON specs (web).
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Compare figma_spec and impl_spec JSON with strict checks (web)")
